...
class ProfileRestControllerTest extends AbstractControllerTest {
    ...
    void registerDuplicateEmail() throws Exception {
        UserTo newTo = new UserTo(null, "duplicateEmail", "user@yandex.ru", "newPassword", 1500);
    ...
    void updateNotValid() throws Exception {
        UserTo updatedNotValidTo = new UserTo(null, "newName", "user@yandex.ru", " ", 1500);
        perform(MockMvcRequestBuilders.put(REST_URL).contentType(MediaType.APPLICATION_JSON)
                .with(userHttpBasic(user))
    ...
    void updateDuplicateEmail() throws Exception {
        UserTo updatedDuplicateEmail = new UserTo(null, "newName", "admin@gmail.com", "newPassword", 1500);
        perform(MockMvcRequestBuilders.put(REST_URL).contentType(MediaType.APPLICATION_JSON)
                .with(userHttpBasic(user))
                .content(JsonUtil.writeValue(updatedDuplicateEmail)))
                .andDo(print())
                .andExpect(status().isConflict())
                .andExpect(content().string(containsString("User with this email already exists")));
    }
